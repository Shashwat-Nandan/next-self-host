...
DOMAIN_NAME="app.codehodl.xyz" # replace with your own
EMAIL="shashwat.nandan@gmail.com" # replace with your own

# Script Vars
REPO_URL="https://github.com/shashwat-nandan/next-self-host.git"
APP_DIR=~/myapp
